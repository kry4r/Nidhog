...
namespace nidhog::graphics::d3d12::fx
{
	namespace
	{
		...
		bool create_fx_pso_and_root_signature()
		{
            ...
            struct {
                ...
                d3dx::d3d12_pipeline_state_subobject_ps                     ps{ shaders::get_engine_shader(shaders::engine_shader::post_process) };
    ...
    void post_process(id3d12_graphics_command_list* cmd_list,
                      const d3d12::d3d12_frame_info& d3d12_info,
                      D3D12_CPU_DESCRIPTOR_HANDLE target_rtv)
    {
        ...
        //NOTE::我们不需要清除Render target
        //      因为每个像素都会被 gpass main buffer中的像素覆盖
        //      同样我们也不需要depthbuffer
