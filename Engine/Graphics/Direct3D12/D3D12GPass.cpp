...
// NOTE (*v*): don't forget to #undef CONSTEXPR when you copy/paste this block of code!
#if USE_STL_VECTOR
#define CONSTEXPR
#else
#define CONSTEXPR constexpr
        ...
        // a cache container store all cached data
        struct gpass_cache
        {
            ...
            id::id_type*                    submesh_gpu_ids{ nullptr };         //find submesh
            id::id_type*                    material_ids{ nullptr };            //find root sig / texture (if any)
...
#undef CONSTEXPR
    ...
    {
        //depth prepass中没有任何颜色输出，我们直接将depth buffer设置为zbuffer
