...
#define CONSTEXPR constexpr
        ...
        public:
            ...
            constexpr graphics::light add(const light_init_info& info)
            {
                ...
                {
                    //In practice, directional light sources are rarely(sun/moon light etc)
        ...
        private:
            ...
            {
                //get refrence then update position and orientation
        ...
        //manage the transform of light data to GPU buffer resouces
...
#undef CONSTEXPR
    ...
    {
        //just get reference and return address
