...
namespace nidhog::graphics::d3d12::camera {
    namespace {
        ...
        //funtion that used DirectXMath func can be constexpr
    ...
    void d3d12_camera::update()
    {
        ...
        if (_is_dirty)
        {
            // NOTE: _near_z and _far_z are swapped because we use inverse depth in d3d12 renderer.(Right-handed coordinate system)
